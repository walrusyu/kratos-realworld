...
func wireApp(confServer *conf.Server, confData *conf.Data, jwt *conf.JWT, consul *conf.Consul, logger log.Logger) (*kratos.App, func(), error) {
	...
	app := newApp(logger, httpServer, grpcServer, consul)
	return app, func() {
		cleanup()
	}, nil
}
